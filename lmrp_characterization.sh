...
#full
./run_alphafold.py --fasta_names lmrp.fasta --job_name lmrp_10_structs_full_dbs_recycle_3_1 --model_names model_5 --overwrite --num_structures 20 --db_preset full_dbs --num_recycle 3 --use_precomputed_msas 
...
./run_alphafold.py --fasta_names lmrp.fasta --job_name lmrp_1_structs_3 --model_names model_5 --overwrite --num_structures 1 --db_preset reduced_dbs --num_recycle 0 --use_precomputed_msas $options $options2

...
"}\n"
"";
const string CudaAmoebaKernelSources::hippoComputeField = "__device__ void computeDirectFieldDampingFactors(real alpha, real r, real& fdamp3, real& fdamp5, real& fdamp7) {\n"
"    real ar = alpha*r;\n"
"    real ar2 = ar*ar;\n"
"    real ar3 = ar2*ar;\n"
"    real ar4 = ar2*ar2;\n"
...
"    }\n"
"}";
const string CudaAmoebaKernelSources::hippoFixedField = "real invR2 = invR*invR;\n"
...
"";
const string CudaAmoebaKernelSources::hippoInteraction = "#ifdef USE_CUTOFF\n"
"unsigned int includeInteraction = (!isExcluded && r2 < CUTOFF_SQUARED);\n"
"#else\n"
"unsigned int includeInteraction = (!isExcluded);\n"
"#endif\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::hippoInteractionHeader = "// Functions that are called from hippoInteraction.cu.\n"
"\n"
...
"\n"
"";
const string CudaAmoebaKernelSources::hippoMultipoles = "extern \"C\" __global__ void computeLabFrameMoments(real4* __restrict__ posq, int4* __restrict__ multipoleParticles, real3* __restrict__ localDipoles,\n"
...
"}\n"
"";
const string CudaAmoebaKernelSources::hippoMutualField = "real fdamp3, fdamp5;\n"
...
"";
const string CudaAmoebaKernelSources::hippoNonbonded = "// This is a modified version of the standard nonbonded kernel for computing HippoNonbondedForce.\n"
...
"#endif\n"
"}";
const string CudaAmoebaKernelSources::hippoNonbondedExceptions = "#define COMPUTING_EXCEPTIONS\n"
"\n"
"/**\n"
